...
struct	memblk	swplist;
struct	memblk	ffslist;
struct	memblk	pdtlist;
...
{	
	...
	//kprintf("etext 0x%08X edata 0x%08X ebss 0x%08X text 0x%08X\n", (uint32)&etext, (uint32)&edata, (uint32)&ebss, (uint32)&text);
